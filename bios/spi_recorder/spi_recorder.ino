...
// set the board to 240mhz or higher for best results (WARNING: higher than 240mhz only works with
// USB if you overvolt the MCU)
// this implements reading SPI mode 3. if you want a different mode, you need to edit these two
// lines:
    ...
    if (!(pins & (1 << pin_ncs))) {
        ...
        if (timed_out) {
            ...
            Serial.printf("len: %d -- micros %d - khz %d - khz limit %d\n", buff_i, elapsed,
                          buff_i * 8 * 1000 / elapsed, n * 1000 / elapsed / 2);
